  ...
  monaco.languages.setMonarchTokensProvider('vimconfig', {
    ...
    tokenizer: {
      root: [
        ...
        [
          /\b(map|nmap|vmap|imap|smap|xmap|omap|cmap|tmap|noremap|nnoremap|vnoremap|inoremap|snoremap|xnoremap|onoremap|cnoremap|tnoremap|unmap|nunmap|vunmap|iunmap|sunmap|xunmap|ounmap|cunmap|tunmap|mapclear|nmapclear|vmapclear|imapclear|smapclear|xmapclear|omapclear|cmapclear|tmapclear)\b/,
          'keyword',
        ],
