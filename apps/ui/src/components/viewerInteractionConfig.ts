...
export function createViewerInteractionConfig(
  ...
  return {
    mouseButtons: {
      ...
      wheel: orthographic ? VIEWER_CONTROL_ACTIONS.ZOOM : VIEWER_CONTROL_ACTIONS.DOLLY,
    },
    touches: {
      one: VIEWER_CONTROL_ACTIONS.TOUCH_ROTATE,
      two: orthographic
        ? VIEWER_CONTROL_ACTIONS.TOUCH_ZOOM_TRUCK
        : VIEWER_CONTROL_ACTIONS.TOUCH_DOLLY_TRUCK,
